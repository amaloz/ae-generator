...
(* OASIS_START *)
(* DO NOT EDIT (digest: 35a996da3b63f7a8ee18896f7af82280) *)
(*
...
let setup_t =
  {
     ...
     build =
       OCamlbuildPlugin.build ["-use-ocamlfind"; "-cflag"; "-safe-string"];
     test = [];
     doc = [];
     ...
     package =
       {
          ...
          homepage = Some "https://github.com/amaloz/ae-generator";
          synopsis = "Authenticated encryption scheme generator";
          description = Some [];
          categories = [];
            ...
            [
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("rpc_parallel", None);
                   ...
                   {exec_custom = false; exec_main_is = "src/main.ml"})
            ];
          plugins = [];
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "h\154\138\020\015\n!\168J\210x}\005\225f\152";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
