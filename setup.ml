...
(* OASIS_START *)
(* DO NOT EDIT (digest: 6bd926e60e3831c93e73ccd4946a61cc) *)
(*
...
let setup_t =
  {
            ...
            [
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "src/aecheck.ml"})
            ];
          plugins = [];
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "r\203\228m7\217\002$\231\182\b\020\014\176\1716";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
